...
inline void init_rgb(void) {
    ...
    // Set Fast PWM mode so TOP is 0xFF, LED turns ON at BOTTOM and turns OFF at COMPARE (OCRx)
    ...
    // Set TCCR2B prescaler to 1024: Table 17-9. Clock Select Bit Description
